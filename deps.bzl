...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:gat8CqE6P6tOgeX30XGLOVNTC26cpM2RWVcreXWtYcM=",
        version = "v0.2.2",
    )
    go_repository(
        name = "com_github_blugelabs_bluge_segment_api",
        importpath = "github.com/blugelabs/bluge_segment_api",
        sum = "h1:cCX1Y2y8v0LZ7+EEJ6gH7dW6TtVTW4RhG0vp3R+N2Lo=",
        version = "v0.2.0",
    )
    go_repository(
        name = "com_github_blugelabs_ice",
        importpath = "github.com/blugelabs/ice",
        sum = "h1:um7wf9e6jbkTVCrOyQq3tKK43fBMOvLUYxbj3Qtc4eo=",
        version = "v1.0.0",
    )
    go_repository(
        name = "com_github_blugelabs_ice_v2",
        importpath = "github.com/blugelabs/ice/v2",
        sum = "h1:mzHbntLjk2v7eDRgoXCgzOsPKN1Tenu9Svo6l9cTLS4=",
        version = "v2.0.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:WocJ5Z7tEdtfBRS0xqw7mLnugXmh4w3hrRo/Qb7Qyqw=",
        version = "v0.0.0-20230830211637-12bbc2498ed8",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_roaringbitmap_gocroaring",
        importpath = "github.com/RoaringBitmap/gocroaring",
        sum = "h1:5nufXUgWpBEUNEJXw7926YAA58ZAQRpWPrQV1xCoSjc=",
        version = "v0.4.0",
    )
    go_repository(
        name = "com_github_roaringbitmap_real_roaring_datasets",
        importpath = "github.com/RoaringBitmap/real-roaring-datasets",
        sum = "h1:ZYlhPbqQFU+AHfgtCdHGDTtRW1a8geZyiE8c6Q+Sl1s=",
        version = "v0.0.0-20190726190000-eb7c87156f76",
    )
    go_repository(
